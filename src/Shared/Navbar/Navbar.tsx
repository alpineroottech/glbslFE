...
const Navbar: React.FC = () => {
  ...
  return (
    <>
      <nav className={`w-full lg:fixed font-Lora z-10 lg:px-5 lg:py-4 transition-all duration-300 ${navbarBgColor}`}>
        <div className="lg:px-10">
          <div className="flex flex-col lg:flex-row items-center justify-between lg:min-h-[80px]">
            ...
            {/* Mobile top bar */}
            <div className="px-3 w-full lg:hidden flex justify-between text-lightBlack bg-khaki h-[70px] items-center">
              <Link to="/">
                <img
                  src="/images/home-1/logo-1.png"
      ...
      {/* Drawer panel */}
      <div
        className={`fixed top-0 right-0 h-full w-[80vw] max-w-[340px] bg-white dark:bg-normalBlack z-50 flex flex-col shadow-2xl transition-transform duration-300 ease-in-out lg:hidden ${
